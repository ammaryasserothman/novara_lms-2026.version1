        ...
        <CartProvider>
          ...
          <HashRouter>
            <Routes>
              ...
              {/* --- Commerce --- */}
              <Route path="/pricing" element={<React.Suspense fallback={<div className="p-8 text-center">Loading...</div>}><PricingPage /></React.Suspense>} />
              <Route path="/cart" element={<React.Suspense fallback={<div className="p-8 text-center">Loading...</div>}><CartPage /></React.Suspense>} />
              <Route path="/checkout" element={<React.Suspense fallback={<div className="p-8 text-center">Loading...</div>}><CheckoutPage /></React.Suspense>} />
