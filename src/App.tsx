...
// --- Lazy Load Features ---
// Marketing
const LandingPage = React.lazy(() => import('./features/marketing/pages/LandingPage').then(module => ({ default: module.LandingPage })));
const FeaturesPage = React.lazy(() => import('./features/marketing/pages/FeaturesPage').then(module => ({ default: module.FeaturesPage })));
const AnalyticsPage = React.lazy(() => import('./features/marketing/pages/AnalyticsPage').then(module => ({ default: module.AnalyticsPage })));
const IntegrationsPage = React.lazy(() => import('./features/marketing/pages/IntegrationsPage').then(module => ({ default: module.IntegrationsPage })));
const SecurityPage = React.lazy(() => import('./features/marketing/pages/SecurityPage').then(module => ({ default: module.SecurityPage })));
const AboutPage = React.lazy(() => import('./features/marketing/pages/AboutPage').then(module => ({ default: module.AboutPage })));
const CareersPage = React.lazy(() => import('./features/marketing/pages/CareersPage').then(module => ({ default: module.CareersPage })));
const CustomersPage = React.lazy(() => import('./features/marketing/pages/CustomersPage').then(module => ({ default: module.CustomersPage })));
const ContactPage = React.lazy(() => import('./features/marketing/pages/ContactPage').then(module => ({ default: module.ContactPage })));
const BlogPage = React.lazy(() => import('./features/marketing/pages/BlogPage').then(module => ({ default: module.BlogPage })));
const DocumentationPage = React.lazy(() => import('./features/marketing/pages/DocumentationPage').then(module => ({ default: module.DocumentationPage })));
const HelpCenterPage = React.lazy(() => import('./features/marketing/pages/HelpCenterPage').then(module => ({ default: module.HelpCenterPage })));
const TermsPage = React.lazy(() => import('./features/marketing/pages/TermsPage').then(module => ({ default: module.TermsPage })));
const PrivacyPage = React.lazy(() => import('./features/marketing/pages/PrivacyPage').then(module => ({ default: module.PrivacyPage })));
