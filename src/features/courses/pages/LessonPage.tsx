...
export const LessonPage: React.FC = () => {
   ...
   // Memoize flattened lessons to prevent O(N) re-allocation on every render/interaction
   const allLessons = React.useMemo(() => course?.syllabus.flatMap(m => m.lessons) || [], [course?.syllabus]);
