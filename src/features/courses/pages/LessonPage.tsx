...
export const LessonPage: React.FC = () => {
   ...
   // Replaced multiple O(N) `flatMap` and `findIndex` calls with a single-pass nested `for...of` loop.
   // This simultaneous traversal pre-calculates the current module, current lesson,
   // previous lesson ID, and next lesson ID in one O(N) pass, significantly reducing redundant array iterations.
   ...
   if (course) {
      ...
      for (const [mIdx, m] of course.syllabus.entries()) {
