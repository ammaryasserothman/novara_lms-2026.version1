...
export const CalendarPage: React.FC = () => {
   ...
   // Group events by day for O(1) lookup during render loop
   // Optimization: Avoids O(N*D) filtering where N is events and D is days in month
   ...
   // Optimization: Memoize sorting of upcoming deadlines to prevent O(N log N) recalculation on every render
