...
export const CalendarPage: React.FC = () => {
   ...
   // Filter Events
   // Bolt Optimization: Calculate derived values directly during render inside useMemo to prevent O(N) recalculations
   ...
   const upcomingDeadlines = useMemo(() => [...filteredEvents].sort((a, b) => a.date.getTime() - b.date.getTime()).filter(e => e.date >= new Date(2024, 9, 20)), [filteredEvents]); // Mock "today" as Oct 20
