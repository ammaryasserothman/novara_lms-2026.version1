...
export const CalendarPage: React.FC = () => {
   ...
   // Pre-group events by day for the current month to avoid O(N*D) filtering in render
   // Bolt ⚡: Replaced O(N*D) render loop filtering with O(N) pre-grouping to optimize calendar rendering
   ...
   const getEventsForDay = React.useCallback((day: number) => {
      return eventsByDayMap.get(day) || EMPTY_EVENTS;
   }, [eventsByDayMap]);
