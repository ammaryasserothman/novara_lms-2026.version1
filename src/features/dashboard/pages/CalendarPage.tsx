...
export const CalendarPage: React.FC = () => {
   ...
   // Events grouped by day for the current month view (O(1) lookup instead of O(N*D))
   ...
   // Wrap sorting in useMemo to prevent expensive O(N log N) recalculations on every render
