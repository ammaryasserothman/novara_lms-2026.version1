...
export const CalendarPage: React.FC = () => {
   ...
   // Events grouped by day for the current month to avoid O(n) filter per day
   ...
   // Memoized upcoming deadlines to prevent O(N log N) sort and filter on every render
