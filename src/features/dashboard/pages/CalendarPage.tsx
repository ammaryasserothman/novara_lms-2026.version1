...
export const CalendarPage: React.FC = () => {
   ...
   // Events for the current month view (O(1) lookup via Map instead of O(N) filter per day)
   ...
   // Memoize sorted upcoming deadlines to prevent O(N log N) resort on every render
