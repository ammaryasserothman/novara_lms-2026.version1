...
export const CalendarPage: React.FC = () => {
   ...
   // Filter Events (Memoized to prevent recalculation on unrelated re-renders)
   const filteredEvents = React.useMemo(() => {
      return EVENTS.filter(e => filter === 'all' || e.type === filter);
   }, [filter]);

   // Group events by day to avoid O(N*D) filtering inside render loops (Performance Optimization)
   ...
   // Memoize expensive sort and filter operations (Performance Optimization)
