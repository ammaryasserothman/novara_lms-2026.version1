...
export const Dashboard: React.FC = () => {
   ...
   // Logic: Get Active Course and other enrolled courses (Max 2 for display)
   // Optimized with single-pass for...in loops to avoid O(N) array allocations from Object.keys() and chained array methods
