...
export const NotificationsPage: React.FC = () => {
    ...
    // ⚡ Bolt: Single-pass iteration to calculate both filtered list and unread count
    // Reduces algorithmic complexity from O(2N) to O(N) by preventing multiple full-array filters.
    // Also memoized to prevent recalculation on unrelated re-renders.
