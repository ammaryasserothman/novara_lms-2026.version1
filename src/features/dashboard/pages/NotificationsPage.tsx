...
export const NotificationsPage: React.FC = () => {
    ...
    // Combine filtering and counting into a single-pass loop with useMemo
    // Reduces algorithmic complexity from O(2N) to O(N) and prevents unnecessary re-renders
