...
export const NotificationsPage: React.FC = () => {
    ...
    // ⚡ Bolt Optimization: Calculate derived state in a single-pass loop with useMemo
    // Resolves O(2N) filtering and prevents recalculation on unrelated re-renders
