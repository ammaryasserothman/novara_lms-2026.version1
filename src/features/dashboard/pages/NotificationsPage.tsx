...
export const NotificationsPage: React.FC = () => {
    ...
    // Optimize: Combine filteredNotifications and unreadCount calculation into a single-pass loop
    // using useMemo to reduce complexity from O(2*N) to O(N) and prevent unnecessary recalculations
